...
fd_statistic = open("statistic.txt", 'w+')

step = 100000
filelist = ['LUN0','LUN1','LUN2','LUN3','LUN4','LUN6']
for index_ in filelist:
    index = '.\\rawfile\\'+index_
    outputfile_simple = "rawfile{}G_simple_{}.txt".format(SSD_size, index_)
